...
@section('content')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="orderHistoryOffcanvas"
        style="width: 400px; border-radius: 20px 0 0 20px;">
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title fw-bold"><i class="fa-solid fa-clock-rotate-left me-2 text-primary"></i>My Orders
            </h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
        </div>
...
@push('scripts')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="checkoutOffcanvas" style="width: 400px; border-radius: 20px 0 0 20px;">
        ...
        // ==========================================
        // 6. ORDER HISTORY SECTION (UPDATED)
        // ==========================================
    ...
    <div class="modal fade" id="orderDetailsModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="p-3 mb-3 bg-white border rounded-4 shadow-sm" id="order-row-${order.id}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="fw-bold text-dark">৳ ${order.total_amount.toLocaleString()}</div>
                    </div>
                    <div class="d-flex gap-2">
        ...
        function viewOrderDetails(orderId) {
            ...
            <div class="d-flex align-items-center gap-3 mb-2 pb-2 border-bottom">
                ...
                <div class="flex-grow-1">
                    <h6 class="mb-0 fw-bold small">${item.name || 'Product'}</h6>
                ...
                let deliveryCharge = (calculatedSubtotal >= 2000) ? 0 : 60;
                let totalAmount = calculatedSubtotal + deliveryCharge;
        ...
        <div class="p-3 bg-light rounded-4">
            <div class="d-flex justify-content-between small mb-1">
                <span class="text-muted">Subtotal:</span>
                <span class="fw-bold">৳ ${calculatedSubtotal.toLocaleString()}</span>
            </div>
            <div class="d-flex justify-content-between small mb-1">
                <span class="text-muted">Delivery Charge:</span>
                <span class="fw-bold">${deliveryCharge === 0 ? '<span class="text-success">FREE</span>' : '৳ ' + deliveryCharge}</span>
            </div>
